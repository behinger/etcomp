...
def get_complete_large_grid_df(subjectnames, ets,outputprefix=''):
    ...
    for subject in subjectnames:
        for et in ets:
            ...
            etsamples, etmsgs, etevents = preprocess.preprocess_et(et,subject,load=True,outputprefix=outputprefix)
...
def get_complete_small_large_grid_df(subjectnames, ets,outputprefix=''):
...
def get_complete_freeview_df(subjectnames, ets,outputprefix=''):
    # make the df for the large GRID for both eyetrackers and all subjects
