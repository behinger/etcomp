...
tstart=GetSecs;
stop=0;
fprintf('\n\n\nUse "c" and "v" to calibrate and validate - afterwards accept with ENTER.\n IT IS VERY IMPORTANT TO FOLLOW THIS. \n else you have to manually click on the pupil labs to synchronize both softwares\n\n')
...
%     end
    ...
    switch key
        ...
        case double('c')
            % start calibration
            sendETNotifications(1,el.requester,'v');
